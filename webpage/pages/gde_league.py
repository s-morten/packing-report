...
def register_callbacks(app, dbh):
    ...
    @app.callback(
        ...
        [Input("gde_league_league_select", "value"), Input("gde_league_date_picker", "value")],
    )
    def update_table(league_select, date_select):
        result = dbh.webpage.get_team_table(
            "2022-04-01", "2022-07-01", ["GER-Bundesliga", "GER-Bundesliga2", "ENG-Premier League"]
        )
