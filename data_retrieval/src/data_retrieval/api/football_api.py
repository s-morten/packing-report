...
class FApi_Handler:
    ...
    def get_schedule(self, league_id, season):
        self.conn.request(
            "GET", f"/fixtures?league={league_id}&season={season}&timezone=Europe/Berlin", headers=self.headers
        )
